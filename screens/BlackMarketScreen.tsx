...
export const BlackMarketScreen: React.FC<BlackMarketScreenProps> = ({ user, onBack, onBuy, setUser }) => {
    ...
    useEffect(() => {
        ...
        updateEconomy();
        const interval = setInterval(updateEconomy, 5000); // 5s update
                                    ...
                                    <div className="flex gap-4 mt-2">
                                        ...
                                        <div className="text-xs text-gray-500">
                                            ...
                                            {isMarketLoading ? (
                                                ...
                                                <div className={marketSentiment > 0 ? "text-red-400" : "text-green-400"}>
                                                    {marketSentiment > 0 ? "通膨 (Inflation)" : "升值 (Deflation)"}
                                                </div>
                                            )}
                                        </div>
                                    </div>
